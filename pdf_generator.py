...
COORDS = {
    "carta_astral": {
        ...
        "mc": (0.30, 0.82), "ic": (0.68, 0.82),
        "planetas": (0.50, 0.50), "box": 0.29,
    },
    "afinidades": {
        "polaridad": (0.29, 0.15), "amistad": (0.60, 0.15),
        "fisica": (0.29, 0.40), "intelectual": (0.60, 0.40),
        "chino": (0.29, 0.30), "celta": (0.60, 0.30),
        "maya": (0.29, 0.63), "egipcio": (0.60, 0.63), "box": 0.29,
    },
    "tarot": {
