...
COORDS = {
    "carta_astral": {
        "nombre": (0.28, 0.15), "datos": (0.70, 0.15),
        "ac": (0.28, 0.63), "dc": (0.60, 0.63),
        "mc": (0.28, 0.74), "ic": (0.60, 0.74),
        "planetas": (0.33, 0.30), "box": 0.35,
    },
    "afinidades": {
        "polaridad": (0.35, 0.28), "amistad": (0.70, 0.28),
        "fisica": (0.35, 0.48), "intelectual": (0.70, 0.48),
        "chino": (0.35, 0.48), "celta": (0.60, 0.48),
        "maya": (0.35, 0.68), "egipcio": (0.60, 0.68), "box": 0.35,
    },
    "tarot": {
        "q1": (0.50, 0.28), "q2": (0.50, 0.42), "q3": (0.50, 0.56),
        "q4": (0.50, 0.70), "q5": (0.50, 0.84), "box": 0.80,
    },
    "horoscopo": {
        "amor": (0.50, 0.24), "trabajo": (0.50, 0.40),
        "dinero": (0.50, 0.55), "salud": (0.50, 0.70),
        "suerte": (0.50, 0.90), "box": 0.80,
    },
}
